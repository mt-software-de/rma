...
class Rma(models.Model):
    ...
    def _prepare_procurement_values(self, warehouse=None, scheduled_date=None):
        self.ensure_one()
        group = self.procurement_group_id or self._create_procurement_group()
        return {
    ...
    def _prepare_reception_procurement_values(self):
    ...
    def _prepare_reception_procurement(self):
        self.ensure_one()
        values = self._prepare_reception_procurement_values()
        return self._prepare_procurement(self.warehouse_id.rma_loc_id, values)
